...
public class GenerateService {
    ...
    public void init() {
        ...
        // 需要生成的表
        // 自定义 service 父类
        strategyConfig.setSuperServiceClass("com.qhz.comb.framework.base.service.BaseService");
        // 自定义 service 实现类父类
        strategyConfig.setSuperServiceImplClass("com.qhz.comb.framework.base.service.impl.BaseServiceImpl");
        // 自定义 controller 父类
        strategyConfig.setSuperControllerClass("com.qhz.comb.framework.base.controller.BaseController");
        ...
        packageConfig.setEntity("model.domain");
